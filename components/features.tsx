  ...
  const features = [
    {
      ...
      description: "Experienced in building structured, efficient web-based systems using PHP (Laravel), MySQL, and APIs.",
    },
    {
      icon: <BookOpen className="h-6 w-6 text-primary" />,
      title: "System Analysis",
      description: "Skilled in analyzing business processes and designing information systems that meet organizational needs.",
    },
    {
      icon: <Laptop className="h-6 w-6 text-primary" />,
      title: "Data Analysis",
      description: "Proficient in data analysis techniques to extract insights and support decision-making processes.",
    },
    {
      icon: <Users className="h-6 w-6 text-primary" />,
      title: "Quality Assurance",
      description: "Experience in software testing and quality assurance to ensure reliable and robust applications.",
    },
  ]
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
          ...
          >
            ...
            <p className="max-w-[800px] mx-auto text-muted-foreground md:text-lg">
              I have experience building structured, efficient web-based systems using technologies such as PHP (Laravel), MySQL, and APIs, while adhering to clean code principles.
            </p>
          </motion.div>
        </div>
